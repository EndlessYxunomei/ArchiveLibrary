...
public interface IDialogService
{
    ...
    Task<string> Ask(string title, string message, int maxLength, string accepButtonText = "ОК", string cancelButtonText = "Отмена");
    Task<string> Ask(string title, string message, string oldValue, int maxLength, string accepButtonText = "ОК", string cancelButtonText = "Отмена");
